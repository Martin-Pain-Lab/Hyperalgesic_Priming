...
description: |
  This is an organized index of code to generate data analysis and visualization for the paper "Inflammatory injury induces pain sensitization that is expressed beyond the site of injury in male (and not in female) mice"
link-citations: yes
...
<!--chapter:end:index-DESKTOP-RELFUC0.Rmd-->
